...
def test_prompt_section_constants_are_stable():
    ...
    assert constants.PROMPT_SECTION_PROJECT_RULES == "Project Rules"
    assert constants.PROMPT_SECTION_OUTPUT_FORMAT == "Output Format"
...
def test_event_and_config_keys_are_namespaced():
    ...
    assert constants.CONFIG_AGENT_SYSTEM_PROMPT == "agent.system_prompt"
    assert constants.CONFIG_MEMORY_RETRIEVAL_TOP_K == "memory.retrieval_top_k"
